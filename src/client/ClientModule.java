...
public class ClientModule
{
    ...
    public void run(String fileName)
    {
        try
        {
            ...
            Reply replyLoading = receive();
            System.out.print(replyLoading.getReplyBody());
            Request requestToServer = null;
            Reply replyServer = null;
            do
                {
                requestToServer = replyServer != null ? console.interactiveMode(replyServer.getReplyCode()) :
                        console.interactiveMode(null);
                if (requestToServer.isEmpty()) continue;
                send(requestToServer);
                replyServer = receive();
                System.out.print(replyServer.getReplyBody());
